...
class ControlConsole(Node):
    ...
    def start_landing(self):
        ...
        wird (dann automatisches Disarm).
        """
        self._landing = True
    ...
    def handle_key(self, key):
        ...
        # Waehrend der Landung keine manuellen Bewegungen zulassen
        # (X/Y/Yaw bleiben eingefroren, damit "an Ort und Stelle" gilt).
        if not self.is_armed() or self._landing:
            return
    ...
    def get_display_lines(self):
        ...
        lines.append("Bewegungs-Tasten wirken nur armed und nicht im Landeanflug.")
