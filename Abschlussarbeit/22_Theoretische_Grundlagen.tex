...
\section{Extended Kallman Filter 2}
In dieser Arbeit wird nicht auf die Sensorfusionen eingegangen, der \gls{ekf2} ist bereits vollständig in dem Flight Controller implementiert.
Zum Verständnis der Positionsbestimmung sowie Parametrierung des \gls{ekf2} ist es notwendig, die Grundlagen des Kalman Filters zu kennen.


Ein Kalman Filter ist ein Algorithmus zur Schätzung des Zustands eines dynamischen Systems 
durch die Kombination von Vorhersagen aus einem Modell und Messungen von Sensoren. \cite{kalman1960}




\section{Flugcontroller PX4 6C}
