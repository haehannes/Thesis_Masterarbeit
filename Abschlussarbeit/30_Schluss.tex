...
Er berechnet aus den Detektionen jeder Kamera je Fiducial-Marker eine Kamerapose in der Karte, verwirft widersprüchliche Schätzungen über eine Ausreißerfilterung nach dem \gls{ransac}-Prinzip und fusioniert die verbleibende Konsensmenge gewichtet.
...
Das entwickelte System bestimmt die Pose des \gls{uav}s im Flug allein aus Fiducial-Markerdetektionen und einer vorab erstellten Karte und stellt sie der Flugsteuerung als externe Referenz bereit.
...
Naheliegend ist, den Positionierungsnodes um eine Schätzung der Kovarianz zu erweitern und diese in der ausgegebenen Nachricht mitzuführen.
