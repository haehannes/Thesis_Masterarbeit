...
% Variables for title page
    ...
    \DATitel{Implementierung eines vision-basierten Lokalisierungssystems für einen Multikopter im Innenraum}
    \DABetreuerTextA{Betreuer}
    \DABetreuerTextB{Betreuer}
    \DABetreuerA{Prof. Dr. rer. nat. Christian Pfitzner}
    \DABetreuerB{Prof. Dr.-Ing. Enrico Schröder}
    \DAOrt{Abgabe: Nürnberg}
    \DAAbgabedatum{23.\,Juli 2026}
