...
\newglossarystyle{symstyle}{
  ...
  % Keine Gruppierungsüberschriften wie X, Y, Z
...
% Variables for title page
    ...
    \DATitel{Implementierung einer fiducialbasierten Lokalisierungssystems für Luftfahrzeuge im Innenraum}
    \DABetreuerTextA{Betreuer}
    \DABetreuerTextB{Betreuer}
    \DABetreuerA{Prof. Dr. rer. nat. Pfitzner}
    \DABetreuerB{Noch nicht sicher}
    \DAOrt{Abgabe: Nürnberg}
    \DAAbgabedatum{10.\,Juni\,2026}
