...
Abschließend wird das aufgebaute System evaluiert.
Die Evaluierung gliedert sich in die beiden Teilaufgaben der Kartierung und der Positionierung.

Diese unterscheiden sich im Rechenaufwand und werden untereinander sowie mit einer bekannten Referenzkarte verglichen.
Die Ergebnisse zeigen, dass sich mit den untersuchten Parametrierungen zuverlässig eine für die Positionsbestimmung nutzbare Karte erzeugen lässt.

Die Positionierung wird in mehreren Testflügen bewertet, bei denen das Fluggerät eine quadratische Flugbahn mit einer Seitenlänge von 2,0~m abfliegt.
Dabei durchläuft es den festgelegten Ablauf aus Steigflug, Schwebeflug, Abfliegen der Flugbahn und Landung vollständig und ohne Eingriff über die Fernsteuerung.
Da dem System keine von der Positionsbestimmung unabhängige Referenz der wahren Pose zur Verfügung steht, beschränkt sich die Bewertung auf die Konsistenz der Fusion im Flugcontroller.
Das Fluggerät folgt der vorgegebenen Flugbahn zuverlässig, zeigt dabei jedoch kontinuierliche Regelbewegungen, die zu geringfügigen Abweichungen von der Sollbahn führen.
